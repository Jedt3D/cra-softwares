...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Function AddSubject(tfSubjectIDTH As String, tfSubjectIDEN As String, tfSubjectNameTH As String, tfCredit As String, tfRemark As String) As Boolean
		  ...
		  App.mDB.InsertRecord("cra_subject", row)
...
#tag Events PushButton1
	#tag Event
		Sub Action()
		  ...
		  If AddSubject( tfSubjectIDTH.Text, tfSubjectIDEN.Text, tfSubjectNameTH.Text, tfCredit.Text, tfRemark.Text) Then
		    winSubject.RefreshDataList
		    Self.Close
		  Else
