...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Function AddEduYear(EduYear As String) As Boolean
		  ...
		  App.mDB.InsertRecord("eduyear", row)
...
#tag Events PushButton1
	#tag Event
		Sub Action()
		  ...
		  If AddEduYear(tfEduyear.Text) Then
		    winEduYear.RefreshDataList()
		    Self.Close
		  Else
