...
Begin Window winEduYear
   ...
   Begin Listbox DataList
      ...
      Index           =   -2147483648
      InitialParent   =   ""
      InitialValue    =   "รายการที่	ปีการศึกษา"
      Italic          =   False
      Left            =   20
      LockBottom      =   True
      LockedInPosition=   False
...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub RefreshDataList()
		  ...
		  Dim sql As String
		  sql = "Select eduyear_id , eduyear FROM eduyear"
		  ...
		  If data <> Nil Then
		    While Not data.EOF
		      DataList.AddRow( _
		      data.IdxField(1).StringValue.DefineEncoding(Encodings.UTF8), data.IdxField(2).StringValue.DefineEncoding(Encodings.UTF8))
		      data.MoveNext
		    Wend
		    data.Close
		  End If
