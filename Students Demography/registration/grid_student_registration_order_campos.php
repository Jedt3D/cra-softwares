<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_student_registration_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_student_registration_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['student_id'] = "on";
   $tab_def_campos['student_id'] = "student_id";
   $tab_converte["student_id"]   = "student_id";
   $tab_labels["student_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_student_registration']['labels']["student_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_student_registration']['labels']["student_id"] : "Student ID";
   $tab_ger_campos['title_id'] = "on";
   $tab_def_campos['title_id'] = "title_id";
   $tab_converte["title_id"]   = "title_id";
   $tab_labels["title_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_student_registration']['labels']["title_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_student_registration']['labels']["title_id"] : "Title";
   $tab_ger_campos['firstname'] = "on";
   $tab_def_campos['firstname'] = "firstname";
   $tab_converte["firstname"]   = "firstname";
   $tab_labels["firstname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_student_registration']['labels']["firstname"])) ? $_SESSION['sc_session'][$sc_init]['grid_student_registration']['labels']["firstname"] : "Firstname";
   $tab_ger_campos['lastname'] = "on";
   $tab_def_campos['lastname'] = "lastname";
   $tab_converte["lastname"]   = "lastname";
   $tab_labels["lastname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_student_registration']['labels']["lastname"])) ? $_SESSION['sc_session'][$sc_init]['grid_student_registration']['labels']["lastname"] : "Lastname";
   $tab_ger_campos['program_id'] = "on";
   $tab_def_campos['program_id'] = "program_id";
   $tab_converte["program_id"]   = "program_id";
   $tab_labels["program_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_student_registration']['labels']["program_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_student_registration']['labels']["program_id"] : "Program";
   $tab_ger_campos['addr_mobilephone'] = "on";
   $tab_def_campos['addr_mobilephone'] = "addr_mobilephone";
   $tab_converte["addr_mobilephone"]   = "addr_mobilephone";
   $tab_labels["addr_mobilephone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_student_registration']['labels']["addr_mobilephone"])) ? $_SESSION['sc_session'][$sc_init]['grid_student_registration']['labels']["addr_mobilephone"] : "Addr Mobilephone";
   $tab_ger_campos['addr_email'] = "on";
   $tab_def_campos['addr_email'] = "addr_email";
   $tab_converte["addr_email"]   = "addr_email";
   $tab_labels["addr_email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_student_registration']['labels']["addr_email"])) ? $_SESSION['sc_session'][$sc_init]['grid_student_registration']['labels']["addr_email"] : "Addr Email";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_student_registration']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_student_registration']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_student_registration']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_student_registration']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_student_registration']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_student_registration']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_student_registration']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_student_registration']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_student_registration']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - student_registration</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_student_registration_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_student_registration']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_student_registration']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
