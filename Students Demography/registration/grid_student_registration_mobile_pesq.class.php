...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "created_date";$Nm_datas[] = "modified_date";$Nm_numeric[] = "id";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_lastname"  <?php echo $str_hide_lastname?>><?php
      $lastname_look = substr($this->Db->qstr($lastname), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_gender"  <?php echo $str_hide_gender?>><?php
      $gender_look = substr($this->Db->qstr($gender), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_blood_group_id"  <?php echo $str_hide_blood_group_id?>><?php
      $blood_group_id_look = substr($this->Db->qstr($blood_group_id), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_school_id"  <?php echo $str_hide_school_id?>><?php
      $school_id_look = substr($this->Db->qstr($school_id), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_school_province"  <?php echo $str_hide_school_province?>><?php
      $school_province_look = substr($this->Db->qstr($school_province), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_cont_mobilephone"  <?php echo $str_hide_cont_mobilephone?>><?php
      $cont_mobilephone_look = substr($this->Db->qstr($cont_mobilephone), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_cont_email"  <?php echo $str_hide_cont_email?>><?php
      $cont_email_look = substr($this->Db->qstr($cont_email), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_firstnameeng"  <?php echo $str_hide_firstnameeng?>><?php
      $firstnameeng_look = substr($this->Db->qstr($firstnameeng), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_lastnameeng"  <?php echo $str_hide_lastnameeng?>><?php
      $lastnameeng_look = substr($this->Db->qstr($lastnameeng), 1, -1); 
      $nmgp_def_dados = array(); 
