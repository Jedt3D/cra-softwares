 ...
 */
    ...
    session_start();
    $SC_apl_proc = "grid_student_registration";
...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['grid_student_registration']['show_skip_charts_option']) || !$_SESSION['sc_session']['grid_student_registration']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
