<div id="form_student_registration_mob_form2" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_addr_address_line" id="hidden_field_data_addr_address" style="<?php echo $sStyleHidden_addr_address; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_addr_address_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_addr_address_label"><span id="id_label_addr_address"><?php echo $this->nm_new_label['addr_address']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_addr_tambon_line" id="hidden_field_data_addr_tambon" style="<?php echo $sStyleHidden_addr_tambon; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_addr_tambon_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_addr_tambon_label"><span id="id_label_addr_tambon"><?php echo $this->nm_new_label['addr_tambon']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_addr_district_line" id="hidden_field_data_addr_district" style="<?php echo $sStyleHidden_addr_district; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_addr_district_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_addr_district_label"><span id="id_label_addr_district"><?php echo $this->nm_new_label['addr_district']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_addr_province_line" id="hidden_field_data_addr_province" style="<?php echo $sStyleHidden_addr_province; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_addr_province_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_addr_province_label"><span id="id_label_addr_province"><?php echo $this->nm_new_label['addr_province']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_addr_postcode_line" id="hidden_field_data_addr_postcode" style="<?php echo $sStyleHidden_addr_postcode; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_addr_postcode_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_addr_postcode_label"><span id="id_label_addr_postcode"><?php echo $this->nm_new_label['addr_postcode']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_addr_homephone_line" id="hidden_field_data_addr_homephone" style="<?php echo $sStyleHidden_addr_homephone; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_addr_homephone_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_addr_homephone_label"><span id="id_label_addr_homephone"><?php echo $this->nm_new_label['addr_homephone']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_addr_mobilephone_line" id="hidden_field_data_addr_mobilephone" style="<?php echo $sStyleHidden_addr_mobilephone; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_addr_mobilephone_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_addr_mobilephone_label"><span id="id_label_addr_mobilephone"><?php echo $this->nm_new_label['addr_mobilephone']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_addr_email_line" id="hidden_field_data_addr_email" style="<?php echo $sStyleHidden_addr_email; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_addr_email_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_addr_email_label"><span id="id_label_addr_email"><?php echo $this->nm_new_label['addr_email']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cont_address_line" id="hidden_field_data_cont_address" style="<?php echo $sStyleHidden_cont_address; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cont_address_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cont_address_label"><span id="id_label_cont_address"><?php echo $this->nm_new_label['cont_address']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cont_tambon_line" id="hidden_field_data_cont_tambon" style="<?php echo $sStyleHidden_cont_tambon; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cont_tambon_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cont_tambon_label"><span id="id_label_cont_tambon"><?php echo $this->nm_new_label['cont_tambon']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cont_district_line" id="hidden_field_data_cont_district" style="<?php echo $sStyleHidden_cont_district; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cont_district_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cont_district_label"><span id="id_label_cont_district"><?php echo $this->nm_new_label['cont_district']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cont_province_line" id="hidden_field_data_cont_province" style="<?php echo $sStyleHidden_cont_province; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cont_province_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cont_province_label"><span id="id_label_cont_province"><?php echo $this->nm_new_label['cont_province']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cont_postcode_line" id="hidden_field_data_cont_postcode" style="<?php echo $sStyleHidden_cont_postcode; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cont_postcode_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cont_postcode_label"><span id="id_label_cont_postcode"><?php echo $this->nm_new_label['cont_postcode']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cont_homephone_line" id="hidden_field_data_cont_homephone" style="<?php echo $sStyleHidden_cont_homephone; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cont_homephone_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cont_homephone_label"><span id="id_label_cont_homephone"><?php echo $this->nm_new_label['cont_homephone']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cont_mobilephone_line" id="hidden_field_data_cont_mobilephone" style="<?php echo $sStyleHidden_cont_mobilephone; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cont_mobilephone_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cont_mobilephone_label"><span id="id_label_cont_mobilephone"><?php echo $this->nm_new_label['cont_mobilephone']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cont_email_line" id="hidden_field_data_cont_email" style="<?php echo $sStyleHidden_cont_email; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cont_email_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cont_email_label"><span id="id_label_cont_email"><?php echo $this->nm_new_label['cont_email']; ?></span></span><br>
