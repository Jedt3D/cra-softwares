...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_student_registration_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_student_registration_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['recarga'];
}
?>
...
<?php
 include_once("form_student_registration_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_student_registration'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_student_registration'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?>
<script type="text/javascript">
var pag_ativa = "form_student_registration_form0";
</script>
<ul class="scTabLine">
<?php
    if (empty($nmgp_num_form) || $nmgp_num_form == "form_student_registration_form0")
    {
...
?>
   <li id="id_form_student_registration_form0" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_student_registration_form0')">
     Information
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_student_registration_form1")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_student_registration_form1" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_student_registration_form1')">
     School
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_student_registration_form2")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_student_registration_form2" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_student_registration_form2')">
     Address & Contact
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_student_registration_form3")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_student_registration_form3" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_student_registration_form3')">
     Father & Mother
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_student_registration_form4")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_student_registration_form4" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_student_registration_form4')">
     Parent & Emergency
    </a>
   </li>
</ul>
...
<div id="form_student_registration_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_program_id_label" id="hidden_field_label_program_id" style="<?php echo $sStyleHidden_program_id; ?>"><span id="id_label_program_id"><?php echo $this->nm_new_label['program_id']; ?></span></TD>
    <TD class="scFormDataOdd css_program_id_line" id="hidden_field_data_program_id" style="<?php echo $sStyleHidden_program_id; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_program_id_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_student_status_label" id="hidden_field_label_student_status" style="<?php echo $sStyleHidden_student_status; ?>"><span id="id_label_student_status"><?php echo $this->nm_new_label['student_status']; ?></span></TD>
    <TD class="scFormDataOdd css_student_status_line" id="hidden_field_data_student_status" style="<?php echo $sStyleHidden_student_status; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_student_status_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['Lookup_student_status'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration']['Lookup_student_status'][] = '0'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_student_id_label" id="hidden_field_label_student_id" style="<?php echo $sStyleHidden_student_id; ?>"><span id="id_label_student_id"><?php echo $this->nm_new_label['student_id']; ?></span></TD>
    <TD class="scFormDataOdd css_student_id_line" id="hidden_field_data_student_id" style="<?php echo $sStyleHidden_student_id; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_student_id_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_title_id_label" id="hidden_field_label_title_id" style="<?php echo $sStyleHidden_title_id; ?>"><span id="id_label_title_id"><?php echo $this->nm_new_label['title_id']; ?></span></TD>
    <TD class="scFormDataOdd css_title_id_line" id="hidden_field_data_title_id" style="<?php echo $sStyleHidden_title_id; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_title_id_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_firstnameeng_label" id="hidden_field_label_firstnameeng" style="<?php echo $sStyleHidden_firstnameeng; ?>"><span id="id_label_firstnameeng"><?php echo $this->nm_new_label['firstnameeng']; ?></span></TD>
    <TD class="scFormDataOdd css_firstnameeng_line" id="hidden_field_data_firstnameeng" style="<?php echo $sStyleHidden_firstnameeng; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_firstnameeng_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_lastnameeng_label" id="hidden_field_label_lastnameeng" style="<?php echo $sStyleHidden_lastnameeng; ?>"><span id="id_label_lastnameeng"><?php echo $this->nm_new_label['lastnameeng']; ?></span></TD>
    <TD class="scFormDataOdd css_lastnameeng_line" id="hidden_field_data_lastnameeng" style="<?php echo $sStyleHidden_lastnameeng; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_lastnameeng_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_student_pid_label" id="hidden_field_label_student_pid" style="<?php echo $sStyleHidden_student_pid; ?>"><span id="id_label_student_pid"><?php echo $this->nm_new_label['student_pid']; ?></span></TD>
    <TD class="scFormDataOdd css_student_pid_line" id="hidden_field_data_student_pid" style="<?php echo $sStyleHidden_student_pid; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_student_pid_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pid_start_label" id="hidden_field_label_pid_start" style="<?php echo $sStyleHidden_pid_start; ?>"><span id="id_label_pid_start"><?php echo $this->nm_new_label['pid_start']; ?></span></TD>
    <TD class="scFormDataOdd css_pid_start_line" id="hidden_field_data_pid_start" style="<?php echo $sStyleHidden_pid_start; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pid_start_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pid_stop_label" id="hidden_field_label_pid_stop" style="<?php echo $sStyleHidden_pid_stop; ?>"><span id="id_label_pid_stop"><?php echo $this->nm_new_label['pid_stop']; ?></span></TD>
    <TD class="scFormDataOdd css_pid_stop_line" id="hidden_field_data_pid_stop" style="<?php echo $sStyleHidden_pid_stop; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pid_stop_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_student_dob_label" id="hidden_field_label_student_dob" style="<?php echo $sStyleHidden_student_dob; ?>"><span id="id_label_student_dob"><?php echo $this->nm_new_label['student_dob']; ?></span></TD>
    <TD class="scFormDataOdd css_student_dob_line" id="hidden_field_data_student_dob" style="<?php echo $sStyleHidden_student_dob; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_student_dob_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_race_id_label" id="hidden_field_label_race_id" style="<?php echo $sStyleHidden_race_id; ?>"><span id="id_label_race_id"><?php echo $this->nm_new_label['race_id']; ?></span></TD>
    <TD class="scFormDataOdd css_race_id_line" id="hidden_field_data_race_id" style="<?php echo $sStyleHidden_race_id; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_race_id_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nationality_id_label" id="hidden_field_label_nationality_id" style="<?php echo $sStyleHidden_nationality_id; ?>"><span id="id_label_nationality_id"><?php echo $this->nm_new_label['nationality_id']; ?></span></TD>
    <TD class="scFormDataOdd css_nationality_id_line" id="hidden_field_data_nationality_id" style="<?php echo $sStyleHidden_nationality_id; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nationality_id_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_religion_id_label" id="hidden_field_label_religion_id" style="<?php echo $sStyleHidden_religion_id; ?>"><span id="id_label_religion_id"><?php echo $this->nm_new_label['religion_id']; ?></span></TD>
    <TD class="scFormDataOdd css_religion_id_line" id="hidden_field_data_religion_id" style="<?php echo $sStyleHidden_religion_id; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_religion_id_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_blood_group_id_label" id="hidden_field_label_blood_group_id" style="<?php echo $sStyleHidden_blood_group_id; ?>"><span id="id_label_blood_group_id"><?php echo $this->nm_new_label['blood_group_id']; ?></span></TD>
    <TD class="scFormDataOdd css_blood_group_id_line" id="hidden_field_data_blood_group_id" style="<?php echo $sStyleHidden_blood_group_id; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_blood_group_id_line" style="vertical-align: top;padding: 0px">
