<div id="form_student_registration_form1" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_school_id_label" id="hidden_field_label_school_id" style="<?php echo $sStyleHidden_school_id; ?>"><span id="id_label_school_id"><?php echo $this->nm_new_label['school_id']; ?></span></TD>
    <TD class="scFormDataOdd css_school_id_line" id="hidden_field_data_school_id" style="<?php echo $sStyleHidden_school_id; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_school_id_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_school_address_label" id="hidden_field_label_school_address" style="<?php echo $sStyleHidden_school_address; ?>"><span id="id_label_school_address"><?php echo $this->nm_new_label['school_address']; ?></span></TD>
    <TD class="scFormDataOdd css_school_address_line" id="hidden_field_data_school_address" style="<?php echo $sStyleHidden_school_address; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_school_address_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_school_district_label" id="hidden_field_label_school_district" style="<?php echo $sStyleHidden_school_district; ?>"><span id="id_label_school_district"><?php echo $this->nm_new_label['school_district']; ?></span></TD>
    <TD class="scFormDataOdd css_school_district_line" id="hidden_field_data_school_district" style="<?php echo $sStyleHidden_school_district; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_school_district_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_school_province_label" id="hidden_field_label_school_province" style="<?php echo $sStyleHidden_school_province; ?>"><span id="id_label_school_province"><?php echo $this->nm_new_label['school_province']; ?></span></TD>
    <TD class="scFormDataOdd css_school_province_line" id="hidden_field_data_school_province" style="<?php echo $sStyleHidden_school_province; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_school_province_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_school_year_grad_label" id="hidden_field_label_school_year_grad" style="<?php echo $sStyleHidden_school_year_grad; ?>"><span id="id_label_school_year_grad"><?php echo $this->nm_new_label['school_year_grad']; ?></span></TD>
    <TD class="scFormDataOdd css_school_year_grad_line" id="hidden_field_data_school_year_grad" style="<?php echo $sStyleHidden_school_year_grad; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_school_year_grad_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_school_gpa_label" id="hidden_field_label_school_gpa" style="<?php echo $sStyleHidden_school_gpa; ?>"><span id="id_label_school_gpa"><?php echo $this->nm_new_label['school_gpa']; ?></span></TD>
    <TD class="scFormDataOdd css_school_gpa_line" id="hidden_field_data_school_gpa" style="<?php echo $sStyleHidden_school_gpa; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_school_gpa_line" style="vertical-align: top;padding: 0px">
