...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'religion_id':
      case 'blood_group_id':
        sc_exib_ocult_pag('form_student_registration_mob_form0');
        break;
      case 'school_id':
      case 'school_address':
      ...
      case 'school_gpa':
        sc_exib_ocult_pag('form_student_registration_mob_form1');
        break;
      case 'addr_address':
      case 'addr_tambon':
      case 'addr_district':
      ...
      case 'cont_email':
        sc_exib_ocult_pag('form_student_registration_mob_form2');
        break;
      case 'father_name':
      case 'father_pid':
      case 'father_status':
      ...
      case 'marriage_status':
        sc_exib_ocult_pag('form_student_registration_mob_form3');
        break;
      case 'parent_name':
      case 'parent_pid':
      case 'parent_status':
      ...
      case 'emer_address':
        sc_exib_ocult_pag('form_student_registration_mob_form4');
        break;
    }
  }
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_personal_photo" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_student_registration_mob_ul_save.php",
