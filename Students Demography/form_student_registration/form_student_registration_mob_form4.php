<div id="form_student_registration_mob_form4" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_parent_name_line" id="hidden_field_data_parent_name" style="<?php echo $sStyleHidden_parent_name; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_parent_name_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_parent_name_label"><span id="id_label_parent_name"><?php echo $this->nm_new_label['parent_name']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_parent_pid_line" id="hidden_field_data_parent_pid" style="<?php echo $sStyleHidden_parent_pid; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_parent_pid_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_parent_pid_label"><span id="id_label_parent_pid"><?php echo $this->nm_new_label['parent_pid']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_parent_status_line" id="hidden_field_data_parent_status" style="<?php echo $sStyleHidden_parent_status; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_parent_status_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_parent_status_label"><span id="id_label_parent_status"><?php echo $this->nm_new_label['parent_status']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_parent_age_line" id="hidden_field_data_parent_age" style="<?php echo $sStyleHidden_parent_age; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_parent_age_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_parent_age_label"><span id="id_label_parent_age"><?php echo $this->nm_new_label['parent_age']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_parent_occupation_line" id="hidden_field_data_parent_occupation" style="<?php echo $sStyleHidden_parent_occupation; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_parent_occupation_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_parent_occupation_label"><span id="id_label_parent_occupation"><?php echo $this->nm_new_label['parent_occupation']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_emer_contact_line" id="hidden_field_data_emer_contact" style="<?php echo $sStyleHidden_emer_contact; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emer_contact_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_emer_contact_label"><span id="id_label_emer_contact"><?php echo $this->nm_new_label['emer_contact']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_emer_homephone_line" id="hidden_field_data_emer_homephone" style="<?php echo $sStyleHidden_emer_homephone; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emer_homephone_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_emer_homephone_label"><span id="id_label_emer_homephone"><?php echo $this->nm_new_label['emer_homephone']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_emer_mobilephone_line" id="hidden_field_data_emer_mobilephone" style="<?php echo $sStyleHidden_emer_mobilephone; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emer_mobilephone_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_emer_mobilephone_label"><span id="id_label_emer_mobilephone"><?php echo $this->nm_new_label['emer_mobilephone']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_emer_relationship_line" id="hidden_field_data_emer_relationship" style="<?php echo $sStyleHidden_emer_relationship; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emer_relationship_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_emer_relationship_label"><span id="id_label_emer_relationship"><?php echo $this->nm_new_label['emer_relationship']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_emer_address_line" id="hidden_field_data_emer_address" style="<?php echo $sStyleHidden_emer_address; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emer_address_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_emer_address_label"><span id="id_label_emer_address"><?php echo $this->nm_new_label['emer_address']; ?></span></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['total'] + 1)?>);</script><?php }} ?>
...
<script> 
<?php
 $NM_pag_atual = "form_student_registration_mob_form0";
 if (isset($this->nmgp_ancora) && $this->nmgp_ancora != "")
 {
     $NM_pag_atual = "form_student_registration_mob_form" . $this->nmgp_ancora;
 }
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_student_registration_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_student_registration_mob");
 parent.scAjaxDetailHeight("form_student_registration_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
