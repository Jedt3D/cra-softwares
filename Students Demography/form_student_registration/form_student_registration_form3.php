<div id="form_student_registration_form3" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_father_name_label" id="hidden_field_label_father_name" style="<?php echo $sStyleHidden_father_name; ?>"><span id="id_label_father_name"><?php echo $this->nm_new_label['father_name']; ?></span></TD>
    <TD class="scFormDataOdd css_father_name_line" id="hidden_field_data_father_name" style="<?php echo $sStyleHidden_father_name; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_father_name_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_father_pid_label" id="hidden_field_label_father_pid" style="<?php echo $sStyleHidden_father_pid; ?>"><span id="id_label_father_pid"><?php echo $this->nm_new_label['father_pid']; ?></span></TD>
    <TD class="scFormDataOdd css_father_pid_line" id="hidden_field_data_father_pid" style="<?php echo $sStyleHidden_father_pid; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_father_pid_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_father_status_label" id="hidden_field_label_father_status" style="<?php echo $sStyleHidden_father_status; ?>"><span id="id_label_father_status"><?php echo $this->nm_new_label['father_status']; ?></span></TD>
    <TD class="scFormDataOdd css_father_status_line" id="hidden_field_data_father_status" style="<?php echo $sStyleHidden_father_status; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_father_status_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_father_age_label" id="hidden_field_label_father_age" style="<?php echo $sStyleHidden_father_age; ?>"><span id="id_label_father_age"><?php echo $this->nm_new_label['father_age']; ?></span></TD>
    <TD class="scFormDataOdd css_father_age_line" id="hidden_field_data_father_age" style="<?php echo $sStyleHidden_father_age; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_father_age_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_father_occupation_label" id="hidden_field_label_father_occupation" style="<?php echo $sStyleHidden_father_occupation; ?>"><span id="id_label_father_occupation"><?php echo $this->nm_new_label['father_occupation']; ?></span></TD>
    <TD class="scFormDataOdd css_father_occupation_line" id="hidden_field_data_father_occupation" style="<?php echo $sStyleHidden_father_occupation; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_father_occupation_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_father_annual_income_label" id="hidden_field_label_father_annual_income" style="<?php echo $sStyleHidden_father_annual_income; ?>"><span id="id_label_father_annual_income"><?php echo $this->nm_new_label['father_annual_income']; ?></span></TD>
    <TD class="scFormDataOdd css_father_annual_income_line" id="hidden_field_data_father_annual_income" style="<?php echo $sStyleHidden_father_annual_income; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_father_annual_income_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_mother_name_label" id="hidden_field_label_mother_name" style="<?php echo $sStyleHidden_mother_name; ?>"><span id="id_label_mother_name"><?php echo $this->nm_new_label['mother_name']; ?></span></TD>
    <TD class="scFormDataOdd css_mother_name_line" id="hidden_field_data_mother_name" style="<?php echo $sStyleHidden_mother_name; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mother_name_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_mother_pid_label" id="hidden_field_label_mother_pid" style="<?php echo $sStyleHidden_mother_pid; ?>"><span id="id_label_mother_pid"><?php echo $this->nm_new_label['mother_pid']; ?></span></TD>
    <TD class="scFormDataOdd css_mother_pid_line" id="hidden_field_data_mother_pid" style="<?php echo $sStyleHidden_mother_pid; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mother_pid_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_mother_status_label" id="hidden_field_label_mother_status" style="<?php echo $sStyleHidden_mother_status; ?>"><span id="id_label_mother_status"><?php echo $this->nm_new_label['mother_status']; ?></span></TD>
    <TD class="scFormDataOdd css_mother_status_line" id="hidden_field_data_mother_status" style="<?php echo $sStyleHidden_mother_status; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mother_status_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_mother_age_label" id="hidden_field_label_mother_age" style="<?php echo $sStyleHidden_mother_age; ?>"><span id="id_label_mother_age"><?php echo $this->nm_new_label['mother_age']; ?></span></TD>
    <TD class="scFormDataOdd css_mother_age_line" id="hidden_field_data_mother_age" style="<?php echo $sStyleHidden_mother_age; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mother_age_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_mother_occupation_label" id="hidden_field_label_mother_occupation" style="<?php echo $sStyleHidden_mother_occupation; ?>"><span id="id_label_mother_occupation"><?php echo $this->nm_new_label['mother_occupation']; ?></span></TD>
    <TD class="scFormDataOdd css_mother_occupation_line" id="hidden_field_data_mother_occupation" style="<?php echo $sStyleHidden_mother_occupation; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mother_occupation_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_mother_annual_income_label" id="hidden_field_label_mother_annual_income" style="<?php echo $sStyleHidden_mother_annual_income; ?>"><span id="id_label_mother_annual_income"><?php echo $this->nm_new_label['mother_annual_income']; ?></span></TD>
    <TD class="scFormDataOdd css_mother_annual_income_line" id="hidden_field_data_mother_annual_income" style="<?php echo $sStyleHidden_mother_annual_income; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mother_annual_income_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_marriage_status_label" id="hidden_field_label_marriage_status" style="<?php echo $sStyleHidden_marriage_status; ?>"><span id="id_label_marriage_status"><?php echo $this->nm_new_label['marriage_status']; ?></span></TD>
    <TD class="scFormDataOdd css_marriage_status_line" id="hidden_field_data_marriage_status" style="<?php echo $sStyleHidden_marriage_status; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_marriage_status_line" style="vertical-align: top;padding: 0px">
