<?php
//
class form_student_registration_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_student_registration_mob']['nm_run_menu'] = 1;
      } 
      if (isset($_SESSION['sc_session'][$script_case_init]['form_student_registration_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_student_registration_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_student_registration_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_student_registration_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_student_registration_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_student_registration_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_student_registration_mob']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_student_registration_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_student_registration_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_student_registration_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_student_registration_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_student_registration_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_student_registration_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_student_registration_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_student_registration_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_student_registration']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_student_registration'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_student_registration_mob']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_student_registration_mob']['upload_field_info']['personal_photo'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_student_registration_mob',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_student_registration_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_student_registration_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_student_registration_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_student_registration_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_student_registration_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_student_registration_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - student_registration";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_student_registration_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_student_registration_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_student_registration_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_student_registration_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_student_registration_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_student_registration_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_student_registration_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_student_registration_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_student_registration_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_student_registration/form_student_registration_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_student_registration_mob_erro.class.php"); 
      }
      $this->Erro      = new form_student_registration_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['opcao']))
         { 
             if ($this->id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_student_registration_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['recarga'] = $this->nmgp_opcao;
      }
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_student_registration_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_student_registration_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_student_registration_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_student_registration_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_student_status(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['Lookup_student_status']) && !in_array($this->student_status, $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['Lookup_student_status']))
          {
    ...
    function ValidateField_gender(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->gender != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['Lookup_gender']) && !in_array($this->gender, $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['Lookup_gender']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id']['keyVal'] = form_student_registration_mob_pack_protect_string($this->nmgp_dados_form['id']);
          }
   } // ajax_return_values
...
$aLookup[] = array(form_student_registration_mob_pack_protect_string('1') => form_student_registration_mob_pack_protect_string("Active"));
$aLookup[] = array(form_student_registration_mob_pack_protect_string('0') => form_student_registration_mob_pack_protect_string("Inactive"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['Lookup_student_status'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['Lookup_student_status'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['student_status']['valList'][$i] = form_student_registration_mob_pack_protect_string($v);
          }
...
where gender not like \"\"";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_student_registration_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_student_registration_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['gender']['valList'][$i] = form_student_registration_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_id($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          $SC_ex_update = true; 
          $SC_ex_upd_or = true; 
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          $this->student_status = $this->student_status_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['total']);
              }

              $this->sc_evento = "insert"; 
              $this->sc_insert_on = true; 
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['parms'] = "id?#?$this->id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_student_registration_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['total'] = $qt_geral_reg_form_student_registration_mob;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_student_registration_mob = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['reg_start'] > $qt_geral_reg_form_student_registration_mob)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['reg_start'] = $qt_geral_reg_form_student_registration_mob; 
          }
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['total'] + 1; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
//---------- 
      if ($this->nmgp_opcao != "novo" && $this->nmgp_opcao != "nada" && $this->nmgp_opcao != "refresh_insert") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['reg_start']) ;  
              } 
          } 
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['parms'] = "id?#?$this->id?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['sub_dir'][0]  = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['reg_start'] < $qt_geral_reg_form_student_registration_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['dados_clone']['personal_photo']);  
              }
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['dados_select'];
                  $this->created_date = $this->nmgp_dados_select['created_date'];  
                  $this->modified_date = $this->nmgp_dados_select['modified_date'];  
                  $this->student_id = $this->nmgp_dados_select['student_id'];  
                  $this->faculty_id = $this->nmgp_dados_select['faculty_id'];  
                  $this->program_id = $this->nmgp_dados_select['program_id'];  
                  $this->title_id = $this->nmgp_dados_select['title_id'];  
                  $this->firstname = $this->nmgp_dados_select['firstname'];  
                  $this->lastname = $this->nmgp_dados_select['lastname'];  
                  $this->gender = $this->nmgp_dados_select['gender'];  
                  $this->student_pid = $this->nmgp_dados_select['student_pid'];  
                  $this->student_dob = $this->nmgp_dados_select['student_dob'];  
                  $this->race_id = $this->nmgp_dados_select['race_id'];  
                  $this->nationality_id = $this->nmgp_dados_select['nationality_id'];  
                  $this->religion_id = $this->nmgp_dados_select['religion_id'];  
                  $this->blood_group_id = $this->nmgp_dados_select['blood_group_id'];  
                  $this->school_id = $this->nmgp_dados_select['school_id'];  
                  $this->school_address = $this->nmgp_dados_select['school_address'];  
                  $this->school_district = $this->nmgp_dados_select['school_district'];  
                  $this->school_province = $this->nmgp_dados_select['school_province'];  
                  $this->school_year_grad = $this->nmgp_dados_select['school_year_grad'];  
                  $this->school_gpa = $this->nmgp_dados_select['school_gpa'];  
                  $this->addr_address = $this->nmgp_dados_select['addr_address'];  
                  $this->addr_tambon = $this->nmgp_dados_select['addr_tambon'];  
                  $this->addr_district = $this->nmgp_dados_select['addr_district'];  
                  $this->addr_province = $this->nmgp_dados_select['addr_province'];  
                  $this->addr_postcode = $this->nmgp_dados_select['addr_postcode'];  
                  $this->addr_homephone = $this->nmgp_dados_select['addr_homephone'];  
                  $this->addr_mobilephone = $this->nmgp_dados_select['addr_mobilephone'];  
                  $this->addr_email = $this->nmgp_dados_select['addr_email'];  
                  $this->cont_address = $this->nmgp_dados_select['cont_address'];  
                  $this->cont_tambon = $this->nmgp_dados_select['cont_tambon'];  
                  $this->cont_district = $this->nmgp_dados_select['cont_district'];  
                  $this->cont_province = $this->nmgp_dados_select['cont_province'];  
                  $this->cont_postcode = $this->nmgp_dados_select['cont_postcode'];  
                  $this->cont_homephone = $this->nmgp_dados_select['cont_homephone'];  
                  $this->cont_mobilephone = $this->nmgp_dados_select['cont_mobilephone'];  
                  $this->cont_email = $this->nmgp_dados_select['cont_email'];  
                  $this->father_name = $this->nmgp_dados_select['father_name'];  
                  $this->father_pid = $this->nmgp_dados_select['father_pid'];  
                  $this->father_status = $this->nmgp_dados_select['father_status'];  
                  $this->father_age = $this->nmgp_dados_select['father_age'];  
                  $this->father_occupation = $this->nmgp_dados_select['father_occupation'];  
                  $this->father_annual_income = $this->nmgp_dados_select['father_annual_income'];  
                  $this->mother_name = $this->nmgp_dados_select['mother_name'];  
                  $this->mother_pid = $this->nmgp_dados_select['mother_pid'];  
                  $this->mother_status = $this->nmgp_dados_select['mother_status'];  
                  $this->mother_age = $this->nmgp_dados_select['mother_age'];  
                  $this->mother_occupation = $this->nmgp_dados_select['mother_occupation'];  
                  $this->mother_annual_income = $this->nmgp_dados_select['mother_annual_income'];  
                  $this->marriage_status = $this->nmgp_dados_select['marriage_status'];  
                  $this->parent_name = $this->nmgp_dados_select['parent_name'];  
                  $this->parent_pid = $this->nmgp_dados_select['parent_pid'];  
                  $this->parent_status = $this->nmgp_dados_select['parent_status'];  
                  $this->parent_age = $this->nmgp_dados_select['parent_age'];  
                  $this->parent_occupation = $this->nmgp_dados_select['parent_occupation'];  
                  $this->parent_annual_income = $this->nmgp_dados_select['parent_annual_income'];  
                  $this->emer_contact = $this->nmgp_dados_select['emer_contact'];  
                  $this->emer_homephone = $this->nmgp_dados_select['emer_homephone'];  
                  $this->emer_mobilephone = $this->nmgp_dados_select['emer_mobilephone'];  
                  $this->emer_relationship = $this->nmgp_dados_select['emer_relationship'];  
                  $this->emer_address = $this->nmgp_dados_select['emer_address'];  
                  $this->token_id = $this->nmgp_dados_select['token_id'];  
                  $this->personal_photo = $this->nmgp_dados_select['personal_photo'];  
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['dados_clone']['personal_photo'] = $this->nmgp_dados_select['personal_photo'];  
                  $this->firstnameeng = $this->nmgp_dados_select['firstnameeng'];  
                  $this->lastnameeng = $this->nmgp_dados_select['lastnameeng'];  
                  $this->pid_start = $this->nmgp_dados_select['pid_start'];  
                  $this->pid_stop = $this->nmgp_dados_select['pid_stop'];  
                  $this->student_status = $this->nmgp_dados_select['student_status'];  
              }
          }
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['foreign_key']))
          {
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        include_once("form_student_registration_mob_form0.php");
        include_once("form_student_registration_mob_form1.php");
        include_once("form_student_registration_mob_form2.php");
        include_once("form_student_registration_mob_form3.php");
        include_once("form_student_registration_mob_form4.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['csrf_token'];
    }
...
where gender not like \"\"";
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_student_registration_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['total'] = $qt_geral_reg_form_student_registration_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_student_registration_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_student_registration_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_student_registration_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
