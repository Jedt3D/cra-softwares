  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_student_registration_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate program_id
  function do_ajax_form_student_registration_mob_validate_program_id()
  {
    var nomeCampo_program_id = "program_id";
    var var_program_id = scAjaxGetFieldText(nomeCampo_program_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_program_id(var_program_id, var_script_case_init, do_ajax_form_student_registration_mob_validate_program_id_cb);
  } // do_ajax_form_student_registration_mob_validate_program_id

  function do_ajax_form_student_registration_mob_validate_program_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_program_id_cb

  // ---------- Validate student_status
  function do_ajax_form_student_registration_mob_validate_student_status()
  {
    var nomeCampo_student_status = "student_status";
    var var_student_status = scAjaxGetFieldRadio(nomeCampo_student_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_student_status(var_student_status, var_script_case_init, do_ajax_form_student_registration_mob_validate_student_status_cb);
  } // do_ajax_form_student_registration_mob_validate_student_status

  function do_ajax_form_student_registration_mob_validate_student_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_student_status_cb

  // ---------- Validate student_id
  function do_ajax_form_student_registration_mob_validate_student_id()
  {
    var nomeCampo_student_id = "student_id";
    var var_student_id = scAjaxGetFieldText(nomeCampo_student_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_student_id(var_student_id, var_script_case_init, do_ajax_form_student_registration_mob_validate_student_id_cb);
  } // do_ajax_form_student_registration_mob_validate_student_id

  function do_ajax_form_student_registration_mob_validate_student_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_student_id_cb

  // ---------- Validate title_id
  function do_ajax_form_student_registration_mob_validate_title_id()
  {
    var nomeCampo_title_id = "title_id";
    var var_title_id = scAjaxGetFieldText(nomeCampo_title_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_title_id(var_title_id, var_script_case_init, do_ajax_form_student_registration_mob_validate_title_id_cb);
  } // do_ajax_form_student_registration_mob_validate_title_id

  function do_ajax_form_student_registration_mob_validate_title_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_title_id_cb

  // ---------- Validate firstname
  function do_ajax_form_student_registration_mob_validate_firstname()
  {
    var nomeCampo_firstname = "firstname";
    var var_firstname = scAjaxGetFieldText(nomeCampo_firstname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_firstname(var_firstname, var_script_case_init, do_ajax_form_student_registration_mob_validate_firstname_cb);
  } // do_ajax_form_student_registration_mob_validate_firstname

  function do_ajax_form_student_registration_mob_validate_firstname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_firstname_cb

  // ---------- Validate lastname
  function do_ajax_form_student_registration_mob_validate_lastname()
  {
    var nomeCampo_lastname = "lastname";
    var var_lastname = scAjaxGetFieldText(nomeCampo_lastname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_lastname(var_lastname, var_script_case_init, do_ajax_form_student_registration_mob_validate_lastname_cb);
  } // do_ajax_form_student_registration_mob_validate_lastname

  function do_ajax_form_student_registration_mob_validate_lastname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_lastname_cb

  // ---------- Validate firstnameeng
  function do_ajax_form_student_registration_mob_validate_firstnameeng()
  {
    var nomeCampo_firstnameeng = "firstnameeng";
    var var_firstnameeng = scAjaxGetFieldText(nomeCampo_firstnameeng);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_firstnameeng(var_firstnameeng, var_script_case_init, do_ajax_form_student_registration_mob_validate_firstnameeng_cb);
  } // do_ajax_form_student_registration_mob_validate_firstnameeng

  function do_ajax_form_student_registration_mob_validate_firstnameeng_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_firstnameeng_cb

  // ---------- Validate lastnameeng
  function do_ajax_form_student_registration_mob_validate_lastnameeng()
  {
    var nomeCampo_lastnameeng = "lastnameeng";
    var var_lastnameeng = scAjaxGetFieldText(nomeCampo_lastnameeng);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_lastnameeng(var_lastnameeng, var_script_case_init, do_ajax_form_student_registration_mob_validate_lastnameeng_cb);
  } // do_ajax_form_student_registration_mob_validate_lastnameeng

  function do_ajax_form_student_registration_mob_validate_lastnameeng_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_lastnameeng_cb

  // ---------- Validate gender
  function do_ajax_form_student_registration_mob_validate_gender()
  {
    var nomeCampo_gender = "gender";
    var var_gender = scAjaxGetFieldRadio(nomeCampo_gender);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_gender(var_gender, var_script_case_init, do_ajax_form_student_registration_mob_validate_gender_cb);
  } // do_ajax_form_student_registration_mob_validate_gender

  function do_ajax_form_student_registration_mob_validate_gender_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "gender";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_gender_cb

  // ---------- Validate student_pid
  function do_ajax_form_student_registration_mob_validate_student_pid()
  {
    var nomeCampo_student_pid = "student_pid";
    var var_student_pid = scAjaxGetFieldText(nomeCampo_student_pid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_student_pid(var_student_pid, var_script_case_init, do_ajax_form_student_registration_mob_validate_student_pid_cb);
  } // do_ajax_form_student_registration_mob_validate_student_pid

  function do_ajax_form_student_registration_mob_validate_student_pid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_student_pid_cb

  // ---------- Validate pid_start
  function do_ajax_form_student_registration_mob_validate_pid_start()
  {
    var nomeCampo_pid_start = "pid_start";
    var var_pid_start = scAjaxGetFieldText(nomeCampo_pid_start);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_pid_start(var_pid_start, var_script_case_init, do_ajax_form_student_registration_mob_validate_pid_start_cb);
  } // do_ajax_form_student_registration_mob_validate_pid_start

  function do_ajax_form_student_registration_mob_validate_pid_start_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_pid_start_cb

  // ---------- Validate pid_stop
  function do_ajax_form_student_registration_mob_validate_pid_stop()
  {
    var nomeCampo_pid_stop = "pid_stop";
    var var_pid_stop = scAjaxGetFieldText(nomeCampo_pid_stop);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_pid_stop(var_pid_stop, var_script_case_init, do_ajax_form_student_registration_mob_validate_pid_stop_cb);
  } // do_ajax_form_student_registration_mob_validate_pid_stop

  function do_ajax_form_student_registration_mob_validate_pid_stop_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_pid_stop_cb

  // ---------- Validate student_dob
  function do_ajax_form_student_registration_mob_validate_student_dob()
  {
    var nomeCampo_student_dob = "student_dob";
    var var_student_dob = scAjaxGetFieldText(nomeCampo_student_dob);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_student_dob(var_student_dob, var_script_case_init, do_ajax_form_student_registration_mob_validate_student_dob_cb);
  } // do_ajax_form_student_registration_mob_validate_student_dob

  function do_ajax_form_student_registration_mob_validate_student_dob_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_student_dob_cb

  // ---------- Validate race_id
  function do_ajax_form_student_registration_mob_validate_race_id()
  {
    var nomeCampo_race_id = "race_id";
    var var_race_id = scAjaxGetFieldText(nomeCampo_race_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_race_id(var_race_id, var_script_case_init, do_ajax_form_student_registration_mob_validate_race_id_cb);
  } // do_ajax_form_student_registration_mob_validate_race_id

  function do_ajax_form_student_registration_mob_validate_race_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "race_id";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_race_id_cb

  // ---------- Validate nationality_id
  function do_ajax_form_student_registration_mob_validate_nationality_id()
  {
    var nomeCampo_nationality_id = "nationality_id";
    var var_nationality_id = scAjaxGetFieldText(nomeCampo_nationality_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_nationality_id(var_nationality_id, var_script_case_init, do_ajax_form_student_registration_mob_validate_nationality_id_cb);
  } // do_ajax_form_student_registration_mob_validate_nationality_id

  function do_ajax_form_student_registration_mob_validate_nationality_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_nationality_id_cb

  // ---------- Validate religion_id
  function do_ajax_form_student_registration_mob_validate_religion_id()
  {
    var nomeCampo_religion_id = "religion_id";
    var var_religion_id = scAjaxGetFieldText(nomeCampo_religion_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_religion_id(var_religion_id, var_script_case_init, do_ajax_form_student_registration_mob_validate_religion_id_cb);
  } // do_ajax_form_student_registration_mob_validate_religion_id

  function do_ajax_form_student_registration_mob_validate_religion_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_religion_id_cb

  // ---------- Validate blood_group_id
  function do_ajax_form_student_registration_mob_validate_blood_group_id()
  {
    var nomeCampo_blood_group_id = "blood_group_id";
    var var_blood_group_id = scAjaxGetFieldText(nomeCampo_blood_group_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_blood_group_id(var_blood_group_id, var_script_case_init, do_ajax_form_student_registration_mob_validate_blood_group_id_cb);
  } // do_ajax_form_student_registration_mob_validate_blood_group_id

  function do_ajax_form_student_registration_mob_validate_blood_group_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_blood_group_id_cb

  // ---------- Validate school_id
  function do_ajax_form_student_registration_mob_validate_school_id()
  {
    var nomeCampo_school_id = "school_id";
    var var_school_id = scAjaxGetFieldText(nomeCampo_school_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_school_id(var_school_id, var_script_case_init, do_ajax_form_student_registration_mob_validate_school_id_cb);
  } // do_ajax_form_student_registration_mob_validate_school_id

  function do_ajax_form_student_registration_mob_validate_school_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_school_id_cb

  // ---------- Validate school_address
  function do_ajax_form_student_registration_mob_validate_school_address()
  {
    var nomeCampo_school_address = "school_address";
    var var_school_address = scAjaxGetFieldText(nomeCampo_school_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_school_address(var_school_address, var_script_case_init, do_ajax_form_student_registration_mob_validate_school_address_cb);
  } // do_ajax_form_student_registration_mob_validate_school_address

  function do_ajax_form_student_registration_mob_validate_school_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_school_address_cb

  // ---------- Validate school_district
  function do_ajax_form_student_registration_mob_validate_school_district()
  {
    var nomeCampo_school_district = "school_district";
    var var_school_district = scAjaxGetFieldText(nomeCampo_school_district);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_school_district(var_school_district, var_script_case_init, do_ajax_form_student_registration_mob_validate_school_district_cb);
  } // do_ajax_form_student_registration_mob_validate_school_district

  function do_ajax_form_student_registration_mob_validate_school_district_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_school_district_cb

  // ---------- Validate school_province
  function do_ajax_form_student_registration_mob_validate_school_province()
  {
    var nomeCampo_school_province = "school_province";
    var var_school_province = scAjaxGetFieldText(nomeCampo_school_province);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_school_province(var_school_province, var_script_case_init, do_ajax_form_student_registration_mob_validate_school_province_cb);
  } // do_ajax_form_student_registration_mob_validate_school_province

  function do_ajax_form_student_registration_mob_validate_school_province_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_school_province_cb

  // ---------- Validate school_year_grad
  function do_ajax_form_student_registration_mob_validate_school_year_grad()
  {
    var nomeCampo_school_year_grad = "school_year_grad";
    var var_school_year_grad = scAjaxGetFieldText(nomeCampo_school_year_grad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_school_year_grad(var_school_year_grad, var_script_case_init, do_ajax_form_student_registration_mob_validate_school_year_grad_cb);
  } // do_ajax_form_student_registration_mob_validate_school_year_grad

  function do_ajax_form_student_registration_mob_validate_school_year_grad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_school_year_grad_cb

  // ---------- Validate school_gpa
  function do_ajax_form_student_registration_mob_validate_school_gpa()
  {
    var nomeCampo_school_gpa = "school_gpa";
    var var_school_gpa = scAjaxGetFieldText(nomeCampo_school_gpa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_school_gpa(var_school_gpa, var_script_case_init, do_ajax_form_student_registration_mob_validate_school_gpa_cb);
  } // do_ajax_form_student_registration_mob_validate_school_gpa

  function do_ajax_form_student_registration_mob_validate_school_gpa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_school_gpa_cb

  // ---------- Validate addr_address
  function do_ajax_form_student_registration_mob_validate_addr_address()
  {
    var nomeCampo_addr_address = "addr_address";
    var var_addr_address = scAjaxGetFieldText(nomeCampo_addr_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_addr_address(var_addr_address, var_script_case_init, do_ajax_form_student_registration_mob_validate_addr_address_cb);
  } // do_ajax_form_student_registration_mob_validate_addr_address

  function do_ajax_form_student_registration_mob_validate_addr_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_addr_address_cb

  // ---------- Validate addr_tambon
  function do_ajax_form_student_registration_mob_validate_addr_tambon()
  {
    var nomeCampo_addr_tambon = "addr_tambon";
    var var_addr_tambon = scAjaxGetFieldText(nomeCampo_addr_tambon);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_addr_tambon(var_addr_tambon, var_script_case_init, do_ajax_form_student_registration_mob_validate_addr_tambon_cb);
  } // do_ajax_form_student_registration_mob_validate_addr_tambon

  function do_ajax_form_student_registration_mob_validate_addr_tambon_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_addr_tambon_cb

  // ---------- Validate addr_district
  function do_ajax_form_student_registration_mob_validate_addr_district()
  {
    var nomeCampo_addr_district = "addr_district";
    var var_addr_district = scAjaxGetFieldText(nomeCampo_addr_district);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_addr_district(var_addr_district, var_script_case_init, do_ajax_form_student_registration_mob_validate_addr_district_cb);
  } // do_ajax_form_student_registration_mob_validate_addr_district

  function do_ajax_form_student_registration_mob_validate_addr_district_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_addr_district_cb

  // ---------- Validate addr_province
  function do_ajax_form_student_registration_mob_validate_addr_province()
  {
    var nomeCampo_addr_province = "addr_province";
    var var_addr_province = scAjaxGetFieldText(nomeCampo_addr_province);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_addr_province(var_addr_province, var_script_case_init, do_ajax_form_student_registration_mob_validate_addr_province_cb);
  } // do_ajax_form_student_registration_mob_validate_addr_province

  function do_ajax_form_student_registration_mob_validate_addr_province_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_addr_province_cb

  // ---------- Validate addr_postcode
  function do_ajax_form_student_registration_mob_validate_addr_postcode()
  {
    var nomeCampo_addr_postcode = "addr_postcode";
    var var_addr_postcode = scAjaxGetFieldText(nomeCampo_addr_postcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_addr_postcode(var_addr_postcode, var_script_case_init, do_ajax_form_student_registration_mob_validate_addr_postcode_cb);
  } // do_ajax_form_student_registration_mob_validate_addr_postcode

  function do_ajax_form_student_registration_mob_validate_addr_postcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_addr_postcode_cb

  // ---------- Validate addr_homephone
  function do_ajax_form_student_registration_mob_validate_addr_homephone()
  {
    var nomeCampo_addr_homephone = "addr_homephone";
    var var_addr_homephone = scAjaxGetFieldText(nomeCampo_addr_homephone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_addr_homephone(var_addr_homephone, var_script_case_init, do_ajax_form_student_registration_mob_validate_addr_homephone_cb);
  } // do_ajax_form_student_registration_mob_validate_addr_homephone

  function do_ajax_form_student_registration_mob_validate_addr_homephone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_addr_homephone_cb

  // ---------- Validate addr_mobilephone
  function do_ajax_form_student_registration_mob_validate_addr_mobilephone()
  {
    var nomeCampo_addr_mobilephone = "addr_mobilephone";
    var var_addr_mobilephone = scAjaxGetFieldText(nomeCampo_addr_mobilephone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_addr_mobilephone(var_addr_mobilephone, var_script_case_init, do_ajax_form_student_registration_mob_validate_addr_mobilephone_cb);
  } // do_ajax_form_student_registration_mob_validate_addr_mobilephone

  function do_ajax_form_student_registration_mob_validate_addr_mobilephone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_addr_mobilephone_cb

  // ---------- Validate addr_email
  function do_ajax_form_student_registration_mob_validate_addr_email()
  {
    var nomeCampo_addr_email = "addr_email";
    var var_addr_email = scAjaxGetFieldText(nomeCampo_addr_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_addr_email(var_addr_email, var_script_case_init, do_ajax_form_student_registration_mob_validate_addr_email_cb);
  } // do_ajax_form_student_registration_mob_validate_addr_email

  function do_ajax_form_student_registration_mob_validate_addr_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_addr_email_cb

  // ---------- Validate cont_address
  function do_ajax_form_student_registration_mob_validate_cont_address()
  {
    var nomeCampo_cont_address = "cont_address";
    var var_cont_address = scAjaxGetFieldText(nomeCampo_cont_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_cont_address(var_cont_address, var_script_case_init, do_ajax_form_student_registration_mob_validate_cont_address_cb);
  } // do_ajax_form_student_registration_mob_validate_cont_address

  function do_ajax_form_student_registration_mob_validate_cont_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_cont_address_cb

  // ---------- Validate cont_tambon
  function do_ajax_form_student_registration_mob_validate_cont_tambon()
  {
    var nomeCampo_cont_tambon = "cont_tambon";
    var var_cont_tambon = scAjaxGetFieldText(nomeCampo_cont_tambon);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_cont_tambon(var_cont_tambon, var_script_case_init, do_ajax_form_student_registration_mob_validate_cont_tambon_cb);
  } // do_ajax_form_student_registration_mob_validate_cont_tambon

  function do_ajax_form_student_registration_mob_validate_cont_tambon_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_cont_tambon_cb

  // ---------- Validate cont_district
  function do_ajax_form_student_registration_mob_validate_cont_district()
  {
    var nomeCampo_cont_district = "cont_district";
    var var_cont_district = scAjaxGetFieldText(nomeCampo_cont_district);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_cont_district(var_cont_district, var_script_case_init, do_ajax_form_student_registration_mob_validate_cont_district_cb);
  } // do_ajax_form_student_registration_mob_validate_cont_district

  function do_ajax_form_student_registration_mob_validate_cont_district_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_cont_district_cb

  // ---------- Validate cont_province
  function do_ajax_form_student_registration_mob_validate_cont_province()
  {
    var nomeCampo_cont_province = "cont_province";
    var var_cont_province = scAjaxGetFieldText(nomeCampo_cont_province);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_cont_province(var_cont_province, var_script_case_init, do_ajax_form_student_registration_mob_validate_cont_province_cb);
  } // do_ajax_form_student_registration_mob_validate_cont_province

  function do_ajax_form_student_registration_mob_validate_cont_province_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_cont_province_cb

  // ---------- Validate cont_postcode
  function do_ajax_form_student_registration_mob_validate_cont_postcode()
  {
    var nomeCampo_cont_postcode = "cont_postcode";
    var var_cont_postcode = scAjaxGetFieldText(nomeCampo_cont_postcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_cont_postcode(var_cont_postcode, var_script_case_init, do_ajax_form_student_registration_mob_validate_cont_postcode_cb);
  } // do_ajax_form_student_registration_mob_validate_cont_postcode

  function do_ajax_form_student_registration_mob_validate_cont_postcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_cont_postcode_cb

  // ---------- Validate cont_homephone
  function do_ajax_form_student_registration_mob_validate_cont_homephone()
  {
    var nomeCampo_cont_homephone = "cont_homephone";
    var var_cont_homephone = scAjaxGetFieldText(nomeCampo_cont_homephone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_cont_homephone(var_cont_homephone, var_script_case_init, do_ajax_form_student_registration_mob_validate_cont_homephone_cb);
  } // do_ajax_form_student_registration_mob_validate_cont_homephone

  function do_ajax_form_student_registration_mob_validate_cont_homephone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_cont_homephone_cb

  // ---------- Validate cont_mobilephone
  function do_ajax_form_student_registration_mob_validate_cont_mobilephone()
  {
    var nomeCampo_cont_mobilephone = "cont_mobilephone";
    var var_cont_mobilephone = scAjaxGetFieldText(nomeCampo_cont_mobilephone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_cont_mobilephone(var_cont_mobilephone, var_script_case_init, do_ajax_form_student_registration_mob_validate_cont_mobilephone_cb);
  } // do_ajax_form_student_registration_mob_validate_cont_mobilephone

  function do_ajax_form_student_registration_mob_validate_cont_mobilephone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_cont_mobilephone_cb

  // ---------- Validate cont_email
  function do_ajax_form_student_registration_mob_validate_cont_email()
  {
    var nomeCampo_cont_email = "cont_email";
    var var_cont_email = scAjaxGetFieldText(nomeCampo_cont_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_cont_email(var_cont_email, var_script_case_init, do_ajax_form_student_registration_mob_validate_cont_email_cb);
  } // do_ajax_form_student_registration_mob_validate_cont_email

  function do_ajax_form_student_registration_mob_validate_cont_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_cont_email_cb

  // ---------- Validate father_name
  function do_ajax_form_student_registration_mob_validate_father_name()
  {
    var nomeCampo_father_name = "father_name";
    var var_father_name = scAjaxGetFieldText(nomeCampo_father_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_father_name(var_father_name, var_script_case_init, do_ajax_form_student_registration_mob_validate_father_name_cb);
  } // do_ajax_form_student_registration_mob_validate_father_name

  function do_ajax_form_student_registration_mob_validate_father_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_father_name_cb

  // ---------- Validate father_pid
  function do_ajax_form_student_registration_mob_validate_father_pid()
  {
    var nomeCampo_father_pid = "father_pid";
    var var_father_pid = scAjaxGetFieldText(nomeCampo_father_pid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_father_pid(var_father_pid, var_script_case_init, do_ajax_form_student_registration_mob_validate_father_pid_cb);
  } // do_ajax_form_student_registration_mob_validate_father_pid

  function do_ajax_form_student_registration_mob_validate_father_pid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_father_pid_cb

  // ---------- Validate father_status
  function do_ajax_form_student_registration_mob_validate_father_status()
  {
    var nomeCampo_father_status = "father_status";
    var var_father_status = scAjaxGetFieldText(nomeCampo_father_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_father_status(var_father_status, var_script_case_init, do_ajax_form_student_registration_mob_validate_father_status_cb);
  } // do_ajax_form_student_registration_mob_validate_father_status

  function do_ajax_form_student_registration_mob_validate_father_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_father_status_cb

  // ---------- Validate father_age
  function do_ajax_form_student_registration_mob_validate_father_age()
  {
    var nomeCampo_father_age = "father_age";
    var var_father_age = scAjaxGetFieldText(nomeCampo_father_age);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_father_age(var_father_age, var_script_case_init, do_ajax_form_student_registration_mob_validate_father_age_cb);
  } // do_ajax_form_student_registration_mob_validate_father_age

  function do_ajax_form_student_registration_mob_validate_father_age_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_father_age_cb

  // ---------- Validate father_occupation
  function do_ajax_form_student_registration_mob_validate_father_occupation()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_father_occupation(var_father_occupation, var_script_case_init, do_ajax_form_student_registration_mob_validate_father_occupation_cb);
  } // do_ajax_form_student_registration_mob_validate_father_occupation

  function do_ajax_form_student_registration_mob_validate_father_occupation_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_father_occupation_cb

  // ---------- Validate father_annual_income
  function do_ajax_form_student_registration_mob_validate_father_annual_income()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_father_annual_income(var_father_annual_income, var_script_case_init, do_ajax_form_student_registration_mob_validate_father_annual_income_cb);
  } // do_ajax_form_student_registration_mob_validate_father_annual_income

  function do_ajax_form_student_registration_mob_validate_father_annual_income_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_father_annual_income_cb

  // ---------- Validate mother_name
  function do_ajax_form_student_registration_mob_validate_mother_name()
  {
    var nomeCampo_mother_name = "mother_name";
    var var_mother_name = scAjaxGetFieldText(nomeCampo_mother_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_mother_name(var_mother_name, var_script_case_init, do_ajax_form_student_registration_mob_validate_mother_name_cb);
  } // do_ajax_form_student_registration_mob_validate_mother_name

  function do_ajax_form_student_registration_mob_validate_mother_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_mother_name_cb

  // ---------- Validate mother_pid
  function do_ajax_form_student_registration_mob_validate_mother_pid()
  {
    var nomeCampo_mother_pid = "mother_pid";
    var var_mother_pid = scAjaxGetFieldText(nomeCampo_mother_pid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_mother_pid(var_mother_pid, var_script_case_init, do_ajax_form_student_registration_mob_validate_mother_pid_cb);
  } // do_ajax_form_student_registration_mob_validate_mother_pid

  function do_ajax_form_student_registration_mob_validate_mother_pid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_mother_pid_cb

  // ---------- Validate mother_status
  function do_ajax_form_student_registration_mob_validate_mother_status()
  {
    var nomeCampo_mother_status = "mother_status";
    var var_mother_status = scAjaxGetFieldText(nomeCampo_mother_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_mother_status(var_mother_status, var_script_case_init, do_ajax_form_student_registration_mob_validate_mother_status_cb);
  } // do_ajax_form_student_registration_mob_validate_mother_status

  function do_ajax_form_student_registration_mob_validate_mother_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_mother_status_cb

  // ---------- Validate mother_age
  function do_ajax_form_student_registration_mob_validate_mother_age()
  {
    var nomeCampo_mother_age = "mother_age";
    var var_mother_age = scAjaxGetFieldText(nomeCampo_mother_age);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_mother_age(var_mother_age, var_script_case_init, do_ajax_form_student_registration_mob_validate_mother_age_cb);
  } // do_ajax_form_student_registration_mob_validate_mother_age

  function do_ajax_form_student_registration_mob_validate_mother_age_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_mother_age_cb

  // ---------- Validate mother_occupation
  function do_ajax_form_student_registration_mob_validate_mother_occupation()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_mother_occupation(var_mother_occupation, var_script_case_init, do_ajax_form_student_registration_mob_validate_mother_occupation_cb);
  } // do_ajax_form_student_registration_mob_validate_mother_occupation

  function do_ajax_form_student_registration_mob_validate_mother_occupation_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_mother_occupation_cb

  // ---------- Validate mother_annual_income
  function do_ajax_form_student_registration_mob_validate_mother_annual_income()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_mother_annual_income(var_mother_annual_income, var_script_case_init, do_ajax_form_student_registration_mob_validate_mother_annual_income_cb);
  } // do_ajax_form_student_registration_mob_validate_mother_annual_income

  function do_ajax_form_student_registration_mob_validate_mother_annual_income_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_mother_annual_income_cb

  // ---------- Validate marriage_status
  function do_ajax_form_student_registration_mob_validate_marriage_status()
  {
    var nomeCampo_marriage_status = "marriage_status";
    var var_marriage_status = scAjaxGetFieldText(nomeCampo_marriage_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_marriage_status(var_marriage_status, var_script_case_init, do_ajax_form_student_registration_mob_validate_marriage_status_cb);
  } // do_ajax_form_student_registration_mob_validate_marriage_status

  function do_ajax_form_student_registration_mob_validate_marriage_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_marriage_status_cb

  // ---------- Validate parent_name
  function do_ajax_form_student_registration_mob_validate_parent_name()
  {
    var nomeCampo_parent_name = "parent_name";
    var var_parent_name = scAjaxGetFieldText(nomeCampo_parent_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_parent_name(var_parent_name, var_script_case_init, do_ajax_form_student_registration_mob_validate_parent_name_cb);
  } // do_ajax_form_student_registration_mob_validate_parent_name

  function do_ajax_form_student_registration_mob_validate_parent_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_parent_name_cb

  // ---------- Validate parent_pid
  function do_ajax_form_student_registration_mob_validate_parent_pid()
  {
    var nomeCampo_parent_pid = "parent_pid";
    var var_parent_pid = scAjaxGetFieldText(nomeCampo_parent_pid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_parent_pid(var_parent_pid, var_script_case_init, do_ajax_form_student_registration_mob_validate_parent_pid_cb);
  } // do_ajax_form_student_registration_mob_validate_parent_pid

  function do_ajax_form_student_registration_mob_validate_parent_pid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_parent_pid_cb

  // ---------- Validate parent_status
  function do_ajax_form_student_registration_mob_validate_parent_status()
  {
    var nomeCampo_parent_status = "parent_status";
    var var_parent_status = scAjaxGetFieldText(nomeCampo_parent_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_parent_status(var_parent_status, var_script_case_init, do_ajax_form_student_registration_mob_validate_parent_status_cb);
  } // do_ajax_form_student_registration_mob_validate_parent_status

  function do_ajax_form_student_registration_mob_validate_parent_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_parent_status_cb

  // ---------- Validate parent_age
  function do_ajax_form_student_registration_mob_validate_parent_age()
  {
    var nomeCampo_parent_age = "parent_age";
    var var_parent_age = scAjaxGetFieldText(nomeCampo_parent_age);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_parent_age(var_parent_age, var_script_case_init, do_ajax_form_student_registration_mob_validate_parent_age_cb);
  } // do_ajax_form_student_registration_mob_validate_parent_age

  function do_ajax_form_student_registration_mob_validate_parent_age_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_parent_age_cb

  // ---------- Validate parent_occupation
  function do_ajax_form_student_registration_mob_validate_parent_occupation()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_parent_occupation(var_parent_occupation, var_script_case_init, do_ajax_form_student_registration_mob_validate_parent_occupation_cb);
  } // do_ajax_form_student_registration_mob_validate_parent_occupation

  function do_ajax_form_student_registration_mob_validate_parent_occupation_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_parent_occupation_cb

  // ---------- Validate parent_annual_income
  function do_ajax_form_student_registration_mob_validate_parent_annual_income()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_parent_annual_income(var_parent_annual_income, var_script_case_init, do_ajax_form_student_registration_mob_validate_parent_annual_income_cb);
  } // do_ajax_form_student_registration_mob_validate_parent_annual_income

  function do_ajax_form_student_registration_mob_validate_parent_annual_income_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_parent_annual_income_cb

  // ---------- Validate emer_contact
  function do_ajax_form_student_registration_mob_validate_emer_contact()
  {
    var nomeCampo_emer_contact = "emer_contact";
    var var_emer_contact = scAjaxGetFieldText(nomeCampo_emer_contact);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_emer_contact(var_emer_contact, var_script_case_init, do_ajax_form_student_registration_mob_validate_emer_contact_cb);
  } // do_ajax_form_student_registration_mob_validate_emer_contact

  function do_ajax_form_student_registration_mob_validate_emer_contact_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_emer_contact_cb

  // ---------- Validate emer_homephone
  function do_ajax_form_student_registration_mob_validate_emer_homephone()
  {
    var nomeCampo_emer_homephone = "emer_homephone";
    var var_emer_homephone = scAjaxGetFieldText(nomeCampo_emer_homephone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_emer_homephone(var_emer_homephone, var_script_case_init, do_ajax_form_student_registration_mob_validate_emer_homephone_cb);
  } // do_ajax_form_student_registration_mob_validate_emer_homephone

  function do_ajax_form_student_registration_mob_validate_emer_homephone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_emer_homephone_cb

  // ---------- Validate emer_mobilephone
  function do_ajax_form_student_registration_mob_validate_emer_mobilephone()
  {
    var nomeCampo_emer_mobilephone = "emer_mobilephone";
    var var_emer_mobilephone = scAjaxGetFieldText(nomeCampo_emer_mobilephone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_emer_mobilephone(var_emer_mobilephone, var_script_case_init, do_ajax_form_student_registration_mob_validate_emer_mobilephone_cb);
  } // do_ajax_form_student_registration_mob_validate_emer_mobilephone

  function do_ajax_form_student_registration_mob_validate_emer_mobilephone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_emer_mobilephone_cb

  // ---------- Validate emer_relationship
  function do_ajax_form_student_registration_mob_validate_emer_relationship()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_emer_relationship(var_emer_relationship, var_script_case_init, do_ajax_form_student_registration_mob_validate_emer_relationship_cb);
  } // do_ajax_form_student_registration_mob_validate_emer_relationship

  function do_ajax_form_student_registration_mob_validate_emer_relationship_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_emer_relationship_cb

  // ---------- Validate emer_address
  function do_ajax_form_student_registration_mob_validate_emer_address()
  {
    var nomeCampo_emer_address = "emer_address";
    var var_emer_address = scAjaxGetFieldText(nomeCampo_emer_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_student_registration_mob_validate_emer_address(var_emer_address, var_script_case_init, do_ajax_form_student_registration_mob_validate_emer_address_cb);
  } // do_ajax_form_student_registration_mob_validate_emer_address

  function do_ajax_form_student_registration_mob_validate_emer_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_student_registration_mob_validate_emer_address_cb
  // ---------- Form
  function do_ajax_form_student_registration_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_student_registration_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
...
?>
  ...
  } // do_ajax_form_student_registration_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_student_registration_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_student_registration_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_student_registration_mob_navigate_form_cb);
  } // do_ajax_form_student_registration_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_student_registration_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_student_registration_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_student_registration_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
...
{
?>
    do_ajax_form_student_registration_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_student_registration_mob_navigate_form_cb
  function sc_hide_form_student_registration_mob_form()
  {
